...
using Cypherly.Identity.API.Extensions;
using Cypherly.Identity.Application.Extensions;
using Cypherly.Identity.Application.Features.Authentication.Token;
using Cypherly.Identity.Domain.Extensions;
using Cypherly.Identity.Infrastructure.Extensions;
...
builder.Services.AddAuthenticationApplication(Assembly.Load("Cypherly.Identity.Application"));

#endregion

#region Infrastructure Layer

builder.Services.AddInfrastructure(configuration, Assembly.Load("Cypherly.Identity.Infrastructure"));
